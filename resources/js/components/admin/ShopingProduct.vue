  ...
  <div>
    <form id="SiteAyarForm">
      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="(item, index) in ExData" :key="item.id">
            <td>
              <div class="card" style="width: 18rem">
                <img
                  src="../static-public/1-1.jpg"
                  alt="Card image cap"
                  width="60"
                  height="80"
                />
            ...
            <td>
              <table class="table">
                ...
                <tbody>
                  <tr>
                    <td>Ürün Türü :</td>
                    <td>Erkek Ayakkabısı->Klasik Ayakkabılar</td>
                  </tr>
                  <tr>
                    <td>Ürün Adı :</td>
                    <td>
                    ...
                    <td>
                      <div class="form-group">
                        <input
                          ...
                          type="text"
                          class="form-control"
                          v-model="ExData[index].UrunFiyat"
                          disabled
                        />
                      </div>
                    </td>
                    ...
                    <td>
                      <div class="form-group">
                        <input
                          ...
                          type="text"
                          class="form-control"
                          v-model="ExData[index].ToplamSatis"
                          disabled
                        />
                      </div>
                    </td>
...
export default {
  ...
  methods: {
    ...
    DeleteSiteAyarlari() {
      alert("Silmek istdeğinizden Eminmisiniz?");
    },
  },
};
</script>
