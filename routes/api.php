...
Route::Resource('admin/customers', 'App\Http\Controllers\Api\SiteUyelerController');
Route::Resource('admin/site-contract', 'App\Http\Controllers\Api\SiteContractController');
Route::Resource('admin/products', 'App\Http\Controllers\Api\SiteProductController',['name' => 'product']);
